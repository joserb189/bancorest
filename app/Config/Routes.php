...
$routes->group('api', ['namespace' => 'App\Controllers\API', 'filter' => 'authFilter'], function($routes) {
    ...
    $routes->post('tipostrasaccion/create', 'TiposTransaccion::create');
    ...
    $routes->get('transaccionenes', 'Transacciones::index');
    $routes->post('transaccionenes/create', 'Transacciones::create');
